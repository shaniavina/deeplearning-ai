...
# * You will use [tf.GradientTape](https://www.tensorflow.org/api_docs/python/tf/GradientTape) to update the image. ([Course 2 Week 3: TensorFlow Introduction Assignment](https://learn.deeplearning.ai/specializations/deep-learning/lesson/wdiba/tensorflow-introduction))
...
# 3. Change the code in [Section 5](#5-1) from :
# 
# ```py
# content_image = np.array(Image.open("images/louvre_small.jpg").resize((img_size, img_size)))
# style_image =  np.array(Image.open("images/monet.jpg").resize((img_size, img_size)))
