...
#     * Specifically, review the week 2's practice assignment ["Python Basics with Numpy"](https://learn.deeplearning.ai/specializations/deep-learning/lesson/joknx/python-basics-with-numpy)
#     
#     
...
# 
# It may be worthwhile to review Course 1 [Derivatives with a Computation Graph](https://learn.deeplearning.ai/specializations/deep-learning/lesson/rsymv/derivatives-with-a-computation-graph)  through  [Backpropagation Intuition](https://learn.deeplearning.ai/specializations/deep-learning/lesson/p8ufp/backpropagation-intuition-(optional)), which decompose the calculation into steps using the chain rule.  
